...
<h1 className="text-2xl font-black texr-slate-800 dark:text-white">
  Dashboared
</h1>
<p>
  wellcome backe Admin here's happning to day
</p>
        </div>
      </div>
{/* center */}
...
<div className="flex items-center space-x-3">
  ...
  <button className="hidden lg:flex items-center space-x-2 py-2 px-4
   bg-linear-to-r from-blue-500 to-purple-600 text-white rounded-xl 
...
<Sun className="w-5 h-5" />
  ...
  {/* nottification from tsegi notiffication active users */}
  <button className="relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300
   hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
<Bell className="w-5 h-5" />
<span className="absolute -top-1  bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
  3
</span>
  </button>
    {/* setting */}
