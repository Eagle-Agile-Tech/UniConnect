  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body : RefreshIndicator(
        onRefresh: () => ref.read(notificationViewModelProvider.future),
        child: Column(
          children: [
            ListTile(
              title: Text('Network Requests'),
              trailing: IconButton(onPressed: () => context.push(Routes.incomingNetworks), icon: Icon(Icons.chevron_right)),
            ),
          ],
        ),
      )
